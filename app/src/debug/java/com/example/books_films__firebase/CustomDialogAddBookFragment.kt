 ...
 * Use the [CustomDialogAddBookFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class CustomDialogAddBookFragment : DialogFragment() {
    // TODO: Rename and change types of parameters
    private var param1: String? = null
    private var param2: String? = null

    private var _binding: FragmentCustomDialogAddBookBinding? = null
    ...
    override fun onCreateView(
        ...
        /*return inflater.inflate(R.layout.fragment_custom_dialog_add_book, container, false)*/

        _binding = FragmentCustomDialogAddBookBinding.inflate(inflater, container, false)
        ...
        binding.addBookButton.setOnClickListener {
            if(binding.titleInput.text.toString().isNotEmpty() && binding.authorInput.text.toString().isNotEmpty()) {
                ...
                val book = Book(binding.titleInput.text.toString(),
    ...
    companion object {
         ...
         * @return A new instance of fragment CustomDialogAddBookFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            CustomDialogAddBookFragment().apply {
